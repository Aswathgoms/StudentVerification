...
<head>
  ...
  <title>Student Database Verification Login</title>
...
<body class="bg-gradient-warning">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 2%">Student Database Verification</h3>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="ovalidation.php">
